...
const s = {
  ...
  timer:       { fontSize: 28, fontWeight: 700, color: '#3b82f6', marginLeft: 'auto', fontVariantNumeric: 'tabular-nums', letterSpacing: 1 },
  activeCard:  { background: '#0f172a', border: '1px solid #1a3a25', borderRadius: 12, padding: '16px 20px', marginBottom: 24 },
  activeHeader:{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 },
  activeLabel: { fontSize: 15, fontWeight: 600, color: '#3b82f6' },
  activeInfo:  { display: 'flex', gap: 20, fontSize: 14, color: '#94a3b8', flexWrap: 'wrap' },
  lateTag:     { background: '#451a03', color: '#fbbf24', borderRadius: 6, padding: '1px 8px', fontSize: 12 },
  inactiveCard:{ background: '#1e293b', border: '1px solid #1a3a25', borderRadius: 12, padding: '16px 20px', marginBottom: 24, display: 'flex', gap: 10, fontSize: 14 },
  actionBlock: { background: '#1e293b', border: '1px solid #1a3a25', borderRadius: 12, padding: '20px', marginBottom: 20, display: 'flex', flexDirection: 'column', gap: 14 },
  noteRow:     { display: 'flex', flexDirection: 'column', gap: 6 },
  label:       { fontSize: 13, color: '#94a3b8' },
  input:       { background: '#0f172a', border: '1px solid #1a3a25', borderRadius: 8, padding: '10px 14px', color: '#f8fafc', fontSize: 14, outline: 'none' },
  btnStart:    { background: '#3b82f6', color: '#0f172a', border: 'none', borderRadius: 8, padding: '14px', fontSize: 16, fontWeight: 800, cursor: 'pointer', letterSpacing: 0.5 },
  ...
  msgOk:       { background: '#0f172a', border: '1px solid #1a3a25', borderRadius: 8, padding: '12px 16px', color: '#3b82f6', fontSize: 14, marginBottom: 20, whiteSpace: 'pre-line' },
  ...
  th:          { padding: '10px 12px', textAlign: 'left', color: '#64748b', borderBottom: '1px solid #1a3a25', fontWeight: 500 },
  td:          { padding: '9px 12px', color: '#94a3b8', borderBottom: '1px solid #1a3a25' },
  okBadge:     { color: '#3b82f6', fontWeight: 600 },
  lateBadge:   { background: '#451a03', color: '#fbbf24', borderRadius: 6, padding: '2px 8px', fontSize: 11 },
  openBadge:   { background: 'rgba(59,130,246,0.1)', color: '#3b82f6', borderRadius: 6, padding: '2px 8px', fontSize: 11 },
}
