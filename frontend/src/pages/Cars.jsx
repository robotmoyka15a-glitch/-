        ...
        <div style={p.headerRight}>
          ...
          {activeShift && (
            <button
              style={{
                ...p.addBtn,
                background: showForm ? '#1a3a25' : C.BRAND_GREEN,
                color: showForm ? C.TEXT_SECONDARY : '#0a0f0d',
              }}
...
const p = {
  ...
  counter:    { fontSize: 13, color: '#4b7a5c' },
  ...
  msgOk:      { background: '#14532d', border: '1px solid #22c55e', borderRadius: 8, padding: '10px 14px', color: '#22c55e', fontSize: 13, marginBottom: 16 },
  ...
  form:       { background: '#111827', border: '1px solid #1a3a25', borderRadius: 12, padding: 24, marginBottom: 24 },
  formTitle:  { fontSize: 15, fontWeight: 600, color: '#86efac', marginBottom: 20 },
  grid:       { display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 16 },
  field:      { display: 'flex', flexDirection: 'column', gap: 6 },
  label:      { fontSize: 12, color: '#86efac', fontWeight: 500 },
  hint:       { fontSize: 11, color: '#4b7a5c' },
  ...
  submitBtn:  { background: '#22c55e', color: '#0a0f0d', border: 'none', borderRadius: 8, padding: '12px 24px', fontSize: 14, fontWeight: 700, cursor: 'pointer', marginTop: 8, width: '100%' },
  tableWrap:  { overflowX: 'auto' },
  empty:      { color: '#4b7a5c', fontSize: 13, padding: '20px 0' },
  table:      { width: '100%', borderCollapse: 'collapse', fontSize: 13 },
  th:         { padding: '10px 12px', textAlign: 'left', color: '#4b7a5c', borderBottom: '1px solid #1a3a25', fontWeight: 500, whiteSpace: 'nowrap' },
  td:         { padding: '8px 12px', color: '#86efac', borderBottom: '1px solid #1a3a25', whiteSpace: 'nowrap' },
  delBtn:     { background: 'none', border: 'none', color: '#4b7a5c', cursor: 'pointer', fontSize: 14, padding: 2 },
}
